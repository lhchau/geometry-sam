...
|---------------|---------|---------|---------------|---------|---------|---------|
| $\rho = 0.05$  | 78.75 % (loss: 0.8063) | ??  | ?? | ?? | 78.86 %  (0.8102) | 78.66 %  (0.8077) |
| $\rho = 0.1$  | 79.35 % (loss: **0.7526**) | ??   | 79.17 (0.7713) | ?? | 79.33 %  (0.7637) | 78.78 %  (0.7778) |
| $\rho = 0.2$  | 79.55 % (loss: **0.7418**) | ??   | 79.36 (0.7455) | ?? | ?? | 78.50 %  (0.7758) |
...
|---------------|---------|---------|---------------|---------|
| $\rho = 0.05$  |78.75 % (loss: 0.8063)| 79.57 %  (0.7714)   | ?? | ?? | ??
| $\rho = 0.1$  |79.35 % (loss: **0.7526**)| 79.73 %  (0.732)   | ?? | ?? | ??
| $\rho = 0.2$  |79.55 % (loss: **0.7418**)| 79.58 %  (0.7283)   | ?? | ?? | ??
...
|---------------|---------|---------|---------------|---------|---------|
| $\rho = 0.1$  |79.35 % (loss: **0.7526**)| 79.39 %  (0.7656)   | ?? | ?? | ?? 
| $\rho = 0.2$  |79.55 % (loss: 0.7418)| 79.76 % (0.7307) | ?? | ?? | ?? 
| $\rho = 0.4$  |79.21 % (loss: 0.7235)| **80.46** %  (**0.7026**)   | 79.57 %  (0.7198) | 79.54 % (0.7172) | 78.81 % (0.7335)
| $\rho = 0.6$  |77.98 % (loss: 0.7656)| 79.64 (0.7186)   | ?? | ?? | ??


| rho\SAMECKPT3-RN34 | ori-SAM | condition=0.1 |
|---------------|---------|---------|
| $\rho = 0.2$  |80.4 % (loss: 0.6995)| **81.63** %  (0.6792)   | 
| $\rho = 0.4$  |80.89 % (loss: 0.6576)| **81.17** %  (0.6934)   | 
| $\rho = 0.6$  |79.65 % (loss: 0.6935)| ??  | 

| rho\SAMECKPT3-WRN28-10 | ori-SAM | condition=0.1 |
|---------------|---------|---------|
| $\rho = 0.2$  |83.91 % (loss: 0.5886)| 83.16 %  (0.6265)   | 
| $\rho = 0.4$  |83.44 % (loss: 0.5697)| 83.34 %  (0.6147)   | 
| $\rho = 0.6$  |83.23 % (loss: 0.5791)| 83.18 (0.6016)  | 
